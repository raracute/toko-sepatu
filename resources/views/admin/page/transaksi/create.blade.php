...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('transaksi_insert')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_sepatu" name="id_sepatu">
                            ...
                            @foreach($sepatu as $d)
                            <option value="{{$d->id_sepatu}}">{{$d->merek}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_kurir" name="id_kurir">
                            ...
                            @foreach($kurir as $d)
                            <option value="{{$d->id_kurir}}">{{$d->id_kurir}}</option>
                            @endforeach
                        </select>
                        <div class="text-danger">
                            @error('id_kurir')
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" name="totalharga">
                    </div> -->
                    <div class="form-group">
