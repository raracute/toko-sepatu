...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('pemasok_insert')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" cols="10" rows="5" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sepatu" id="sepatu" class="form-control">
                            @foreach ($sepatu as $sepatuItem)
                                <option value="{{ $sepatuItem->id_sepatu }}">{{ $sepatuItem->merek }}</option>
                            @endforeach
                        </select>
                    </div>
